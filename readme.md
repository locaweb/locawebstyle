...
...
  ...
  <link rel="stylesheet" type="text/css" href="//assets.locaweb.com.br/locastyle/3.7.3/stylesheets/locastyle.css">
...
</head>
<body>
  <!-- Your code -->
  ...
  <script src="//assets.locaweb.com.br/locastyle/3.7.3/javascripts/locastyle.js"></script>
</body>
```
...
### Use o Locaweb Style
Você pode usar o Locaweb Style de várias formas: [direto pelo nosso servidor](//assets.locaweb.com.br/locastyle/3.7.3/javascripts/locastyle.js), via Bower ou baixando os assets para usar offline.
